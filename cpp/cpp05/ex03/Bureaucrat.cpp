...
void Bureaucrat::executeForm(AForm const & form)
{
	...
	{
		std::cout << R << this->getName() << " can't execute an unisigned form\n" RST;
		
	}
	else if (this->getGrade() <= form.getLevelExec())
		std::cout << G << this->getName() << " executed " << form.getName() << RST<< std::endl;
	else
	{
		std::cout << R << this->getName() << " doesn't have execution level required\n" RST;
	}
}
