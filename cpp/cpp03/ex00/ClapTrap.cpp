...
/*   Updated: 2024/08/22 15:50:50 by alimotta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : name("Unknow"), hit(10), energy(10), attack_p(0)
{
	std::cout << "[ClapTrap] Default constructor" << std::endl;
}

ClapTrap::ClapTrap(std::string new_name) : name(new_name), hit(10), energy(10), attack_p(0)
{
